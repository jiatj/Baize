...
import type { ChatItem, CommandItem, SpeechToTextSettings, TextToSpeechSettings, VisionFile, VisionSettings } from '@/types/app'
...
export type IChatProps = {
  ...
  onSend?: (message: string, files?: VisionFile[], otherInputs?: any) => void
