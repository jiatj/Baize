...
import StopCircle from '@/app/components/base/icons/solid/StopCircle'
import { audioToText } from '@/service/index'
...
const VoiceInput = ({
  ...
  const handleStopRecorder = useCallback(async () => {
    ...
    try {
      const audioResponse = await audioToText(url, formData, { bodyStringify: false, deleteContentType: true })
